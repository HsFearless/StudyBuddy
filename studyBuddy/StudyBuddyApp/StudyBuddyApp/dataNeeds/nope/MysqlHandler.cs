...
//namespace studyBuddy.dataNeeds.Nope
//{
//    class MysqlHandler
//    {
...
//            string username = "cDKryxhEGc";
//            string password = "rw0faFJV0H";
//            string database = "cDKryxhEGc";
//            int port = 3306;
//            string conArgs = $"server={host};port={port};database={database};" +
...
//                    throw new NotImplementedException(); ///exceptions.ConfirmationNotReceived(); //^unhandled exception
//            if (!OpenNewConnection())
//                return false;
//            cmdCon = new MySqlCommand(fullSql, this.con);
//            int affectedRows = cmdCon.ExecuteNonQuery();
